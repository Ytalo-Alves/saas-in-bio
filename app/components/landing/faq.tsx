...
function FaqCard({ title, description }: FaqCardProps) {
  return (
    <div className="w-[351px] flex flex-col gap-3 p-5 rounded-2xl border border-ACCENT-PURPLE bg-BORDER-PRIMARY">
      <p className="font-bold text-white">{title}</p>
      <p className="text-CONTENT-BODY text-balance">{description}</p>
    </div>
  );
}
